 ...
 * @todo caching added - Alot of data cached?
...
class MetaTune {
    ...
    private function requestContent($url) {
        ...
        if (isset($http_response_header) && is_array($http_response_header)) {
            $errorCode = str_replace("HTTP/1.0 ", "", $http_response_header[0]);
            ...
            if ($errorCode == "304 Not Modified") {
                ...
                file_put_contents(dirname(__FILE__) . '/../' . $filename, $contents . $lastChangedDate);
            }
        }
        return $contents;
    }
